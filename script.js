...
const i18n = {
    pt: {
        ...
        'nav-sobre'          : 'Sobre',
        'nav-musicas'        : 'Músicas',
        'hero-desc'          : 'Minimal, Indie Dance e Techno fundidos numa identidade sonora única.<br>Groove, atmosfera e energia de pista em cada lançamento.',
        'hero-listen'        : 'Ouvir Agora',
        'stat-labels'        : 'Gravadoras',
        'stat-years'         : 'Início',
        ...
        'sobre-tag'          : 'SOBRE',
        'sobre-title'        : 'Um som que conecta<br><span class="text-glow">o underground</span>',
        'sobre-p1'           : 'Quint é um artista e produtor brasileiro que iniciou sua trajetória na música eletrônica em 2024, construindo rapidamente um nome sólido na cena. Com uma identidade sonora moldada pela fusão de minimal, indie dance e techno, cria tracks que equilibram groove, atmosfera e energia de pista, entregando experiências imersivas e contemporâneas.',
        'sobre-p2'           : 'Em pouco tempo, já lançou músicas em selos respeitados como Cuff, Muzenga Records, Player One Records e Indie Beats, consolidando sua presença no circuito underground internacional. Suas produções também receberam suporte de nomes como Amine Edge, Jessika Branka, Jay Mariani, Deeper Purpose, Kolombo, Loulou Players, Ricck, Stizi, Gabss, Fezzo, Fatsync e BRN.',
        'sobre-p3'           : 'Sempre em evolução, Quint busca traduzir suas influências em um som autêntico, explorando grooves hipnóticos, basslines marcantes e texturas modernas. Seu foco é construir uma narrativa musical que conecta diferentes matizes de house e techno, mantendo a essência underground e a inovação constante.',
        'sobre-p4'           : '',
        'sobre-p5'           : '',
    ...
    en: {
        ...
        'nav-sobre'          : 'About',
        'nav-musicas'        : 'Music',
        'hero-desc'          : 'Minimal, Indie Dance and Techno fused into a unique sonic identity.<br>Groove, atmosphere and dancefloor energy in every release.',
        ...
        'sobre-tag'          : 'ABOUT',
        'sobre-title'        : 'A sound that connects<br><span class="text-glow">the underground</span>',
        'sobre-p1'           : 'Quint is a Brazilian artist and producer who began his journey in electronic music in 2024, quickly building a solid name within the scene. With a sonic identity shaped by the fusion of minimal, indie dance, and techno, he crafts tracks that balance groove, atmosphere, and dancefloor energy, delivering immersive and contemporary experiences.',
        'sobre-p2'           : 'In a short time, he has already released music on respected labels such as Cuff, Muzenga Records, Player One Records, and Indie Beats, strengthening his presence within the international underground circuit. His productions have received support from artists including Amine Edge, Jessika Branka, Jay Mariani, Deeper Purpose, Kolombo, Loulou Players, Ricck, Stizi, Gabss, Fezzo, Fatsync, and BRN.',
        'sobre-p3'           : 'Always evolving, Quint seeks to translate his influences into an authentic sound, exploring hypnotic grooves, strong basslines, and modern textures. His focus is to deliver a musical narrative that connects different shades of house and techno, staying true to the underground essence and constant innovation.',
        'sobre-p4'           : '',
        'sobre-p5'           : '',
    ...
    es: {
        ...
        'nav-sobre'          : 'Sobre',
        'nav-musicas'        : 'Música',
        'hero-desc'          : 'Minimal, Indie Dance y Techno fusionados en una identidad sonora única.<br>Groove, atmósfera y energía de pista en cada lanzamiento.',
        ...
        'sobre-tag'          : 'SOBRE',
        'sobre-title'        : 'Un sonido que conecta<br><span class="text-glow">el underground</span>',
        'sobre-p1'           : 'Quint es un artista y productor brasileño que inició su trayectoria en la música electrónica en 2024, construyendo rápidamente un nombre sólido en la escena. Con una identidad sonora moldeada por la fusión de minimal, indie dance y techno, crea tracks que equilibran groove, atmósfera y energía de pista, entregando experiencias inmersivas y contemporáneas.',
        'sobre-p2'           : 'En poco tiempo, ya lanzó música en sellos respetados como Cuff, Muzenga Records, Player One Records e Indie Beats, consolidando su presencia en el circuito underground internacional. Sus producciones también recibieron apoyo de Amine Edge, Jessika Branka, Jay Mariani, Deeper Purpose, Kolombo, Loulou Players, Ricck, Stizi, Gabss, Fezzo, Fatsync y BRN.',
        'sobre-p3'           : 'Siempre en evolución, Quint busca traducir sus influencias en un sonido auténtico, explorando grooves hipnóticos, basslines contundentes y texturas modernas. Su enfoque es construir una narrativa musical que conecta distintos matices de house y techno, manteniendo la esencia underground y la innovación constante.',
        'sobre-p4'           : '',
        'sobre-p5'           : '',
    ...
    zh: {
        ...
        'nav-sobre'          : '关于',
        'nav-musicas'        : '音乐',
        'hero-desc'          : 'Minimal、独立舞曲与Techno融合的独特音乐身份。<br>每个作品都充满律动、氛围与舞池能量。',
        'hero-listen'        : '立即收听',
        'stat-labels'        : '唱片公司',
        'stat-years'         : '起步年份',
        'badge-pressure'     : '舞台张力',
        ...
        'sobre-tag'          : '关于',
        'sobre-title'        : '连接地下音乐的<br><span class="text-glow">声音</span>',
        'sobre-p1'           : 'Quint 是一位巴西艺术家和制作人，于 2024 年开始涉足电子音乐，迅速在圈内建立了坚实的名声。他的音乐身份融合了 minimal、indie dance 和 techno，作品在律动、氛围与舞池能量之间取得平衡，带来沉浸式的当代体验。',
        'sobre-p2'           : '在短时间内，他已在 Cuff、Muzenga Records、Player One Records 和 Indie Beats 等受人尊敬的厂牌发行音乐，进一步巩固了在国际地下圈的存在。其作品也获得了 Amine Edge、Jessika Branka、Jay Mariani、Deeper Purpose、Kolombo、Loulou Players、Ricck、Stizi、Gabss、Fezzo、Fatsync 和 BRN 等人的支持。',
        'sobre-p3'           : 'Quint 不断进化，致力于将自身影响转化为真实的声音，探索催眠律动、强劲 bassline 与现代音色。他的目标是构建一个跨越不同 house 与 techno 色彩的音乐叙事，同时坚守地下精神与持续创新。',
        'sobre-p4'           : '',
        'sobre-p5'           : '',
        'lugares-tag'        : '舞台足迹',
    ...
    de: {
        ...
        'nav-sobre'          : 'Über mich',
        'nav-musicas'        : 'Musik',
        'hero-desc'          : 'Minimal, Indie Dance und Techno zu einer einzigartigen Klangidentität verschmolzen.<br>Groove, Atmosphäre und Floor-Energie in jedem Release.',
        ...
        'sobre-tag'          : 'ÜBER MICH',
        'sobre-title'        : 'Ein Sound, der<br><span class="text-glow">den Underground verbindet</span>',
        'sobre-p1'           : 'Quint ist ein brasilianischer Künstler und Produzent, der 2024 seine Reise in die elektronische Musik begann und sich schnell einen festen Namen in der Szene aufgebaut hat. Mit einer Klangidentität aus Minimal, Indie Dance und Techno schafft er Tracks, die Groove, Atmosphäre und Floor-Energie vereinen.',
        'sobre-p2'           : 'In kurzer Zeit hat er bereits auf renommierten Labels wie Cuff, Muzenga Records, Player One Records und Indie Beats veröffentlicht und ist im internationalen Underground-Kreislauf präsent. Seine Produktionen erhielten Support von Amine Edge, Jessika Branka, Jay Mariani, Deeper Purpose, Kolombo, Loulou Players, Ricck, Stizi, Gabss, Fezzo, Fatsync und BRN.',
        'sobre-p3'           : 'Stets im Wandel, übersetzt Quint seine Einflüsse in einen authentischen Sound — hypnotische Grooves, starke Basslines und moderne Texturen. Sein Ziel ist eine musikalische Erzählung, die verschiedene Facetten von House und Techno verbindet und dabei dem Underground-Geist treu bleibt.',
        'sobre-p4'           : '',
        'sobre-p5'           : '',
    ...
    ja: {
        ...
        'nav-sobre'          : 'プロフィール',
        'nav-musicas'        : 'ミュージック',
        'hero-desc'          : 'ミニマル、インディーダンス、テクノが融合した唯一無二のサウンドアイデンティティ。<br>すべてのリリースにグルーヴ、アトモスフィア、フロアエナジーを。',
        'hero-listen'        : '今すぐ聴く',
        'stat-labels'        : 'レーベル',
        'stat-years'         : '始動年',
        ...
        'sobre-tag'          : 'プロフィール',
        'sobre-title'        : 'アンダーグラウンドを<br><span class="text-glow">つなぐサウンド</span>',
        'sobre-p1'           : 'Quint はブラジル人アーティスト・プロデューサーで、2024年に電子音楽の世界に踏み込み、シーンで確固たる地位を築きつつある。Minimal、Indie Dance、Technoを融合させた独自のサウンドアイデンティティで、グルーヴ・アトモスフィア・フロアエナジーを兼ね備えたトラックを生み出している。',
        'sobre-p2'           : '短期間のうちに、Cuff、Muzenga Records、Player One Records、Indie Beats など著名なレーベルで音楽をリリースし、国際的なアンダーグラウンドサーキットでの存在感を確立。Amine Edge、Jessika Branka、Jay Mariani、Deeper Purpose、Kolombo、Loulou Players、Ricck、Stizi、Gabss、Fezzo、Fatsync、BRN らからサポートを受けている。',
        'sobre-p3'           : '常に進化し続けるQuintは、催眠的なグルーヴ、力強いベースライン、現代的なテクスチャーを探求しながら、自身の影響を本物のサウンドへと昇華させる。HouseとTechnoの様々な色調をつなぐ音楽的ナラティブを構築し、アンダーグラウンドのエッセンスと不断の革新を追い求めている。',
        'sobre-p4'           : '',
        'sobre-p5'           : '',
        'lugares-tag'        : 'ステージ実績',
