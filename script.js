...
const i18n = {
    pt: {
        ...
        'sobre-p1'           : 'Sou o Quint, artista e produtor brasileiro focado na fusão entre minimal, indie dance e techno.',
        'sobre-p2'           : 'Minha proposta sonora nasce do equilíbrio entre groove, atmosfera e energia de pista, criando experiências imersivas, modernas e conectadas à essência underground.',
        'sobre-p3'           : 'Mesmo tendo iniciado minha trajetória na música eletrônica em 2024, já venho construindo espaço na cena com lançamentos por selos como Cuff, Muzenga Records, Player One Records e Indie Beats.',
        'sobre-p4'           : 'Minhas produções também receberam suporte de nomes como Amine Edge, Jessika Branka, Jay Mariani, Deeper Purpose, Kolombo, Loulou Players, Ricck, Stizi, Gabss, Fezzo, Fatsync e BRN.',
        'sobre-p5'           : 'Em constante evolução, busco desenvolver uma identidade autêntica, explorando grooves hipnóticos, linhas de baixo marcantes e texturas contemporâneas para levar à pista uma narrativa sonora intensa, sofisticada e viva.',
    ...
    en: {
        ...
        'sobre-p1'           : 'I\'m Quint, a Brazilian artist and producer focused on the fusion of minimal, indie dance, and techno.',
        'sobre-p2'           : 'My sound proposal is born from the balance between groove, atmosphere, and dancefloor energy, creating immersive, modern experiences connected to the underground essence.',
        'sobre-p3'           : 'Although I started my journey in electronic music in 2024, I\'ve been building my presence in the scene with releases on labels such as Cuff, Muzenga Records, Player One Records, and Indie Beats.',
        'sobre-p4'           : 'My productions have also received support from artists including Amine Edge, Jessika Branka, Jay Mariani, Deeper Purpose, Kolombo, Loulou Players, Ricck, Stizi, Gabss, Fezzo, Fatsync, and BRN.',
        'sobre-p5'           : 'Always evolving, I seek to develop an authentic identity, exploring hypnotic grooves, striking basslines, and contemporary textures to deliver an intense, sophisticated, and alive sonic narrative to the dancefloor.',
    ...
    es: {
        ...
        'sobre-p1'           : 'Soy Quint, artista y productor brasileño enfocado en la fusión entre minimal, indie dance y techno.',
        'sobre-p2'           : 'Mi propuesta sonora nace del equilibrio entre groove, atmósfera y energía de pista, creando experiencias inmersivas, modernas y conectadas a la esencia underground.',
        'sobre-p3'           : 'Aunque inicié mi trayectoria en la música electrónica en 2024, ya vengo construyendo espacio en la escena con lanzamientos en sellos como Cuff, Muzenga Records, Player One Records e Indie Beats.',
        'sobre-p4'           : 'Mis producciones también han recibido apoyo de nombres como Amine Edge, Jessika Branka, Jay Mariani, Deeper Purpose, Kolombo, Loulou Players, Ricck, Stizi, Gabss, Fezzo, Fatsync y BRN.',
        'sobre-p5'           : 'En constante evolución, busco desarrollar una identidad auténtica, explorando grooves hipnóticos, líneas de bajo contundentes y texturas contemporáneas para llevar a la pista una narrativa sonora intensa, sofisticada y viva.',
    ...
    zh: {
        ...
        'sobre-p1'           : '我是 Quint，一位专注于 Minimal、Indie Dance 和 Techno 融合的巴西艺术家与制作人。',
        'sobre-p2'           : '我的音乐提案源于律动、氛围与舞池能量之间的平衡，创造沉浸式、现代且与地下精神紧密相连的体验。',
        'sobre-p3'           : '尽管我在 2024 年才开始涉足电子音乐，但已在 Cuff、Muzenga Records、Player One Records 和 Indie Beats 等厂牌发行作品，在场景中逐步建立存在感。',
        'sobre-p4'           : '我的制作也获得了 Amine Edge、Jessika Branka、Jay Mariani、Deeper Purpose、Kolombo、Loulou Players、Ricck、Stizi、Gabss、Fezzo、Fatsync 和 BRN 等名字的支持。',
        'sobre-p5'           : '不断进化中，我致力于打造真实的音乐身份，探索催眠律动、强劲 bassline 与当代音色，为舞池带来激烈、精致而充满生命力的声音叙事。',
        'lugares-tag'        : '舞台足迹',
    ...
    de: {
        ...
        'sobre-p1'           : 'Ich bin Quint, brasilianischer Künstler und Produzent mit Fokus auf die Fusion von Minimal, Indie Dance und Techno.',
        'sobre-p2'           : 'Mein Soundkonzept entsteht aus der Balance zwischen Groove, Atmosphäre und Floor-Energie und schafft immersive, moderne Erfahrungen, die mit der Underground-Essenz verbunden sind.',
        'sobre-p3'           : 'Obwohl ich 2024 mit meiner Reise in die elektronische Musik begann, baue ich bereits Präsenz in der Szene auf — mit Veröffentlichungen auf Labels wie Cuff, Muzenga Records, Player One Records und Indie Beats.',
        'sobre-p4'           : 'Meine Produktionen haben auch Support von Amine Edge, Jessika Branka, Jay Mariani, Deeper Purpose, Kolombo, Loulou Players, Ricck, Stizi, Gabss, Fezzo, Fatsync und BRN erhalten.',
        'sobre-p5'           : 'Stets im Wandel, strebe ich danach, eine authentische Identität zu entwickeln — hypnotische Grooves, markante Basslines und zeitgemäße Texturen für eine intensive, raffinierte und lebendige Sounderzählung auf dem Floor.',
    ...
    ja: {
        ...
        'sobre-p1'           : '私はQuint、Minimal・Indie Dance・Technoの融合に特化したブラジル人アーティスト・プロデューサーです。',
        'sobre-p2'           : '私のサウンドはグルーヴ、アトモスフィア、フロアエナジーのバランスから生まれ、アンダーグラウンドの本質に根ざした没入感あるモダンな体験を創り出します。',
        'sobre-p3'           : '2024年に電子音楽の世界に踏み込んだばかりですが、Cuff、Muzenga Records、Player One Records、Indie Beats などのレーベルからリリースを重ね、シーンで確固たる存在感を築いています。',
        'sobre-p4'           : '私の制作はAmine Edge、Jessika Branka、Jay Mariani、Deeper Purpose、Kolombo、Loulou Players、Ricck、Stizi、Gabss、Fezzo、Fatsync、BRNなどからサポートを受けています。',
        'sobre-p5'           : '常に進化しながら、催眠的なグルーヴ、力強いベースライン、現代的なテクスチャーを探求し、フロアに届ける音楽的ナラティブを——激しく、洗練され、生き生きとしたものへ——磨き続けています。',
        'lugares-tag'        : 'ステージ実績',
