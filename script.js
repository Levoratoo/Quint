...
const i18n = {
    pt: {
        ...
        'nav-lancamento'     : 'Lançamento',
        'nav-autorais'       : 'Autorais',
        'nav-conquistas'     : 'Charts',
        'autorais-tag'       : 'ORIGINAIS',
        'cq-tag'             : 'CONQUISTAS',
        'cq-title'           : 'Top charts na <span class="text-glow">Beatport</span>',
        'cq-intro'           : 'Posições alcançadas nas paradas com tracks autorais do Quint.',
        'cq-badge'           : 'CHART',
        'cq-rank-label'      : 'TOP',
        'cq-ganesha-desc'    : 'Melhor posição nas charts da Beatport.',
        'cq-always-desc'     : 'Entrada forte nas paradas globais da plataforma.',
        'rl-tag'             : 'LANÇAMENTO',
        'rl-new'             : 'NOVO',
        'rl-title1'          : 'SINGLE',
        'rl-artists'         : 'QUINT · THIIMD',
        'rl-desc'            : 'Novo single em evidência na Dance Works Records. Groove direto, identidade forte e pronto para a pista.',
        'rl-listen'          : 'Ouvir no Spotify',
        'nav-suporte'        : 'Suporte',
        'sup-tag'            : 'NAS PISTAS',
        'sup-title'          : 'SUPORTE',
        'sup-desc-lead'      : 'Quando uma música conecta de verdade, ela entra no arsenal de quem manda na pista. Tenho tracks baixadas e sendo tocadas por DJs como:',
        'sup-desc-foot'      : 'e outros nomes relevantes da cena nacional e internacional.',
        'nav-aftermoovie'    : 'After',
        'am-tag'             : 'AFTER MOOVIE',
        'am-title'           : 'FORMATURA',
        'am-subtitle'        : 'Volare · 2025',
        'am-desc'            : 'O dia que marcou o fim de um ciclo e o início de outro. A formatura de mixagem pela Volare, registrada em vídeo do começo ao fim.',
        'am-placeholder'     : 'Vídeo em breve',
        'am-cta'             : 'Assistir no YouTube',
        ...
        'dl-cta-zip-all'     : 'Baixar pacote completo (.zip)',
        'dl-btn'             : 'Baixar',
        ...
        'pl-tag': 'LIVE',
        'pl-new': 'AO VIVO',
        'pl-title1': 'APRESENTAÇÃO',
        'pl-subtitle': 'Park Art · 2026',
        'pl-desc': 'Set ao vivo no Park Art. Pressão de pista, groove e energia do começo ao fim, registrado para reviver o momento na íntegra.',
        'pl-listen': 'Assistir no YouTube',
        'music-tag'          : 'OUÇA',
    ...
    en: {
        ...
        'nav-lancamento'     : 'Release',
        'nav-autorais'       : 'Originals',
        'nav-conquistas'     : 'Charts',
        'autorais-tag'       : 'ORIGINALS',
        'cq-tag'             : 'ACHIEVEMENTS',
        'cq-title'           : 'Top charts on <span class="text-glow">Beatport</span>',
        'cq-intro'           : 'Chart positions reached with Quint\'s original tracks.',
        'cq-badge'           : 'CHART',
        'cq-rank-label'      : 'TOP',
        'cq-ganesha-desc'    : 'Best position on Beatport charts.',
        'cq-always-desc'     : 'Strong entry on the platform\'s global charts.',
        'rl-tag'             : 'RELEASE',
        'rl-new'             : 'NEW',
        'rl-title1'          : 'SINGLE',
        'rl-artists'         : 'QUINT · THIIMD',
        'rl-desc'            : 'New single in the spotlight on Dance Works Records. Direct groove, strong identity, built for the floor.',
        'rl-listen'          : 'Listen on Spotify',
        'nav-suporte'        : 'Support',
        'sup-tag'            : 'ON THE FLOOR',
        'sup-title'          : 'SUPPORT',
        'sup-desc-lead'      : 'When a track truly connects, it ends up in the arsenal of those who run the floor. My tracks have been downloaded and played by DJs such as:',
        'sup-desc-foot'      : 'and other relevant names from the national and international scene.',
        'nav-aftermoovie'    : 'After',
        'am-tag'             : 'AFTER MOVIE',
        'am-title'           : 'GRADUATION',
        'am-subtitle'        : 'Volare · 2025',
        'am-desc'            : 'The day that marked the end of one chapter and the beginning of another. The mixing graduation from Volare, captured on video from start to finish.',
        'am-placeholder'     : 'Coming soon',
        'am-cta'             : 'Watch on YouTube',
        ...
        'dl-cta-zip-all'     : 'Download full package (.zip)',
        'dl-btn'             : 'Download',
        ...
        'pl-tag': 'LIVE',
        'pl-new': 'LIVE',
        'pl-title1': 'PERFORMANCE',
        'pl-subtitle': 'Park Art · 2026',
        'pl-desc': 'Live set at Park Art. Dance floor pressure, groove and energy from start to finish, captured in full.',
        'pl-listen': 'Watch on YouTube',
        'music-tag'          : 'LISTEN',
    ...
    es: {
        ...
        'nav-lancamento'     : 'Lanzamiento',
        'nav-autorais'       : 'Originales',
        'nav-conquistas'     : 'Charts',
        'autorais-tag'       : 'ORIGINALES',
        'cq-tag'             : 'LOGROS',
        'cq-title'           : 'Top charts en <span class="text-glow">Beatport</span>',
        'cq-intro'           : 'Posiciones alcanzadas en las listas con tracks originales de Quint.',
        'cq-badge'           : 'CHART',
        'cq-rank-label'      : 'TOP',
        'cq-ganesha-desc'    : 'Mejor posición en las charts de Beatport.',
        'cq-always-desc'     : 'Fuerte entrada en las paradas globales de la plataforma.',
        'rl-tag'             : 'LANZAMIENTO',
        'rl-new'             : 'NUEVO',
        'rl-title1'          : 'SINGLE',
        'rl-artists'         : 'QUINT · THIIMD',
        'rl-desc'            : 'Nuevo single destacado en Dance Works Records. Groove directo, identidad fuerte y listo para la pista.',
        'rl-listen'          : 'Escuchar en Spotify',
        'nav-suporte'        : 'Soporte',
        'sup-tag'            : 'EN LA PISTA',
        'sup-title'          : 'SOPORTE',
        'sup-desc-lead'      : 'Cuando una música conecta de verdad, entra en el arsenal de quien manda en la pista. Tengo tracks descargadas y siendo tocadas por DJs como:',
        'sup-desc-foot'      : 'y otros nombres relevantes de la escena nacional e internacional.',
        'nav-aftermoovie'    : 'After',
        'am-tag'             : 'AFTER MOVIE',
        'am-title'           : 'GRADUACIÓN',
        'am-subtitle'        : 'Volare · 2025',
        'am-desc'            : 'El día que marcó el fin de un ciclo y el inicio de otro. La graduación de mezcla en Volare, grabada en video de principio a fin.',
        'am-placeholder'     : 'Próximamente',
        'am-cta'             : 'Ver en YouTube',
        ...
        'dl-cta-zip-all'     : 'Descargar paquete completo (.zip)',
        'dl-btn'             : 'Descargar',
        ...
        'pl-tag': 'LIVE',
        'pl-new': 'EN VIVO',
        'pl-title1': 'PRESENTACIÓN',
        'pl-subtitle': 'Park Art · 2026',
        'pl-desc': 'Set en vivo en Park Art. Presión de pista, groove y energía de principio a fin, registrado para revivir el momento.',
        'pl-listen': 'Ver en YouTube',
        'music-tag'          : 'ESCUCHA',
    ...
    zh: {
        ...
        'autorais-tag'       : '原创音乐',
        'cq-tag'             : '成就',
        'cq-title'           : '<span class="text-glow">Beatport</span> 榜单成绩',
        'cq-intro'           : 'Quint 原创曲目在榜单上取得的成绩。',
        'cq-badge'           : 'CHART',
        'cq-rank-label'      : 'TOP',
        'cq-ganesha-desc'    : 'Beatport 榜单最佳排名。',
        'cq-always-desc'     : '在全球榜单上强势上榜。',
        'rl-tag'             : '新发行',
        'rl-new'             : '新作',
        'rl-title1'          : '单曲',
        'rl-artists'         : 'QUINT · THIIMD',
        'rl-desc'            : 'Dance Works Records 重磅新单曲。直接有力的 Groove，鲜明身份，为舞池而生。',
        'rl-listen'          : '在 Spotify 收听',
        'nav-suporte'        : '支持',
        'sup-tag'            : '舞台上',
        'sup-title'          : '支持',
        'sup-desc-lead'      : '当一首曲目真正打动人时，它会进入掌控舞池的人的武器库。我的作品已被以下DJ下载并在现场播放：',
        'sup-desc-foot'      : '以及国内外场景中其他重要名字。',
        'nav-aftermoovie'    : 'After',
        'am-tag'             : '毕业影片',
        'am-title'           : '毕业典礼',
        'am-subtitle'        : 'Volare · 2025',
        'am-desc'            : '这一天标志着一个阶段的结束和另一个阶段的开始。Volare混音毕业典礼，从头到尾全程录像。',
        'am-placeholder'     : '即将上线',
        'am-cta'             : '在YouTube上观看',
        'drops-sub'          : '能量拉满。点击观看。',
        ...
        'pl-title1': '现场演出',
        'pl-subtitle': 'Park Art · 2026',
        'pl-desc': 'Park Art现场演出。从头到尾充满舞池压迫感、律动与能量，完整记录。',
        'pl-listen': '在 YouTube 观看',
        'music-tag'          : '收听',
    ...
    de: {
        ...
        'cq-tag'             : 'ERFOLGE',
        'cq-title'           : 'Top-Charts auf <span class="text-glow">Beatport</span>',
        'cq-intro'           : 'Chart-Positionen mit Quints eigenen Tracks.',
        'cq-badge'           : 'CHART',
        'cq-rank-label'      : 'TOP',
        'cq-ganesha-desc'    : 'Beste Position in den Beatport-Charts.',
        'cq-always-desc'     : 'Starker Einstieg in die globalen Charts der Plattform.',
        'rl-tag'             : 'RELEASE',
        'rl-new'             : 'NEU',
        'rl-title1'          : 'SINGLE',
        'rl-artists'         : 'QUINT · THIIMD',
        'rl-desc'            : 'Neuer Single im Fokus auf Dance Works Records. Direkter Groove, starke Identität, gemacht für den Floor.',
        'rl-listen'          : 'Auf Spotify hören',
        'nav-suporte'        : 'Support',
        'sup-tag'            : 'AUF DEM FLOOR',
        'sup-title'          : 'SUPPORT',
        'sup-desc-lead'      : 'Wenn ein Track wirklich verbindet, landet er im Arsenal derer, die den Floor bestimmen. Meine Tracks wurden heruntergeladen und von DJs gespielt wie:',
        'sup-desc-foot'      : 'und weitere relevante Namen der nationalen und internationalen Szene.',
        'nav-aftermoovie'    : 'After',
        'am-tag'             : 'AFTER MOVIE',
        'am-title'           : 'ABSCHLUSS',
        'am-subtitle'        : 'Volare · 2025',
        'am-desc'            : 'Der Tag, der das Ende eines Kapitels und den Beginn eines anderen markierte. Der Mixing-Abschluss bei Volare, von Anfang bis Ende auf Video festgehalten.',
        'am-placeholder'     : 'Demnächst',
        'am-cta'             : 'Auf YouTube ansehen',
        ...
        'dl-cta-zip-all'     : 'Komplettpaket herunterladen (.zip)',
        ...
        'pl-title1': 'AUFTRITT',
        'pl-subtitle': 'Park Art · 2026',
        'pl-desc': 'Live-Set im Park Art. Dancefloor-Druck, Groove und Energie von Anfang bis Ende, komplett aufgenommen.',
        'pl-listen': 'Auf YouTube ansehen',
        'music-tag'          : 'HÖREN',
    ...
    ja: {
        ...
        'cq-tag'             : '実績',
        'cq-title'           : '<span class="text-glow">Beatport</span> チャート入り',
        'cq-intro'           : 'Quintのオリジナル曲が達成したチャート順位。',
        'cq-badge'           : 'CHART',
        'cq-rank-label'      : 'TOP',
        'cq-ganesha-desc'    : 'Beatportチャートでの最高順位。',
        'cq-always-desc'     : 'グローバルチャートへの力強いランクイン。',
        'rl-tag'             : '新リリース',
        'rl-new'             : 'NEW',
        'rl-title1'          : 'シングル',
        'rl-artists'         : 'QUINT · THIIMD',
        'rl-desc'            : 'Dance Works Recordsからの注目の新シングル。ダイレクトなグルーヴと強いアイデンティティでフロア向け。',
        'rl-listen'          : 'Spotifyで聴く',
        'nav-suporte'        : 'サポート',
        'sup-tag'            : 'フロアで',
        'sup-title'          : 'サポート',
        'sup-desc-lead'      : '本当に響くトラックは、フロアを支配するDJのアーセナルに入る。私のトラックは、次のようなDJにダウンロードされ、プレイされています：',
        'sup-desc-foot'      : 'その他、国内外のシーンで重要なアーティストたち。',
        'nav-aftermoovie'    : 'アフター',
        'am-tag'             : 'アフタームービー',
        'am-title'           : '卒業',
        'am-subtitle'        : 'Volare · 2025',
        'am-desc'            : 'あるサイクルの終わりと新たな始まりを刻んだ一日。Volareでのミキシングコース졸업式をビデオで記録。',
        'am-placeholder'     : '近日公開',
        'am-cta'             : 'YouTubeで視聴',
        ...
        'tl-section-title'   : '<span class="text-glow">2年</span>の軌跡',
        ...
        'dl-cta-zip-all'     : 'フルパッケージをダウンロード（.zip）',
        'dl-btn'             : 'ダウンロード',
        'dl-tab-photos'      : '写真',
        'dl-tab-logo'        : 'ロゴ',
        'dl-logo-tag'        : '公式ロゴ',
        ...
        'pl-title1': 'パフォーマンス',
        'pl-subtitle': 'Park Art · 2026',
        'pl-desc': 'Park Artでのライブセット。最初から最後までフロアを揺らすプレッシャーとグルーヴ、エネルギーを収録。',
        'pl-listen': 'YouTubeで視聴',
        'music-tag'          : '聴く',
